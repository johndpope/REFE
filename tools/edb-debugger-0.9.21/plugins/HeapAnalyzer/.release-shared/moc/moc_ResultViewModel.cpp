...
static const char qt_meta_stringdata_HeapAnalyzer__ResultViewModel[] = {
    "HeapAnalyzer::ResultViewModel\0"
};
...
const QMetaObjectExtraData HeapAnalyzer::ResultViewModel::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject HeapAnalyzer::ResultViewModel::staticMetaObject = {
    { &QAbstractItemModel::staticMetaObject, qt_meta_stringdata_HeapAnalyzer__ResultViewModel,
      qt_meta_data_HeapAnalyzer__ResultViewModel, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &HeapAnalyzer::ResultViewModel::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_HeapAnalyzer__ResultViewModel))
