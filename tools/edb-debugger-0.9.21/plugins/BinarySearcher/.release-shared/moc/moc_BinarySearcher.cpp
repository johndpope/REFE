...
static const char qt_meta_stringdata_BinarySearcher__BinarySearcher[] = {
    "BinarySearcher::BinarySearcher\0"
    "Evan Teran\0author\0http://www.codef00.com\0"
    "url\0\0show_menu()\0mnuStackFindASCII()\0"
};
...
const QMetaObjectExtraData BinarySearcher::BinarySearcher::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject BinarySearcher::BinarySearcher::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_BinarySearcher__BinarySearcher,
      qt_meta_data_BinarySearcher__BinarySearcher, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &BinarySearcher::BinarySearcher::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_BinarySearcher__BinarySearcher))
