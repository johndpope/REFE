...
static const char qt_meta_stringdata_DialogEditGPR[] = {
    "DialogEditGPR\0\0onTextEdited(QString)\0"
};
...
const QMetaObjectExtraData DialogEditGPR::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject DialogEditGPR::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_DialogEditGPR,
      qt_meta_data_DialogEditGPR, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &DialogEditGPR::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DialogEditGPR))
