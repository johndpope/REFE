...
static const char qt_meta_stringdata_OpcodeSearcher__OpcodeSearcher[] = {
    "OpcodeSearcher::OpcodeSearcher\0"
...
const QMetaObjectExtraData OpcodeSearcher::OpcodeSearcher::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject OpcodeSearcher::OpcodeSearcher::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_OpcodeSearcher__OpcodeSearcher,
      qt_meta_data_OpcodeSearcher__OpcodeSearcher, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &OpcodeSearcher::OpcodeSearcher::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_OpcodeSearcher__OpcodeSearcher))
