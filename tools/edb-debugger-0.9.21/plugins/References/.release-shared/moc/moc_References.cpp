...
static const char qt_meta_stringdata_References__References[] = {
    "References::References\0Evan Teran\0"
...
const QMetaObjectExtraData References::References::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject References::References::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_References__References,
      qt_meta_data_References__References, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &References::References::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_References__References))
