...
public:
    ...
    {
        OptionsPage->setWindowTitle(QApplication::translate("CheckVersion::OptionsPage", "Check Version Plugin", 0, QApplication::UnicodeUTF8));
        checkBox->setText(QApplication::translate("CheckVersion::OptionsPage", "Check for new version on startup", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
