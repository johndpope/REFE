...
static const char qt_meta_stringdata_DumpState__OptionsPage[] = {
    "DumpState::OptionsPage\0\0i\0"
    "on_instructionsBeforeIP_valueChanged(int)\0"
    "on_instructionsAfterIP_valueChanged(int)\0"
    "value\0on_colorizeOutput_toggled(bool)\0"
};
...
const QMetaObjectExtraData DumpState::OptionsPage::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject DumpState::OptionsPage::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_DumpState__OptionsPage,
      qt_meta_data_DumpState__OptionsPage, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &DumpState::OptionsPage::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DumpState__OptionsPage))
