...
static const char qt_meta_stringdata_DialogInputBinaryString[] = {
    "DialogInputBinaryString\0"
};
...
const QMetaObjectExtraData DialogInputBinaryString::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject DialogInputBinaryString::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_DialogInputBinaryString,
      qt_meta_data_DialogInputBinaryString, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &DialogInputBinaryString::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DialogInputBinaryString))
