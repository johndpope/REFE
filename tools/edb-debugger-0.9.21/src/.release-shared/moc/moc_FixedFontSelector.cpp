...
static const char qt_meta_stringdata_FixedFontSelector[] = {
    "FixedFontSelector\0\0font\0"
    "currentFontChanged(QFont)\0"
    "setCurrentFont(QFont)\0setCurrentFont(QString)\0"
    "on_fontCombo_currentFontChanged(QFont)\0"
    "index\0on_fontSize_currentIndexChanged(int)\0"
};
...
const QMetaObjectExtraData FixedFontSelector::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject FixedFontSelector::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_FixedFontSelector,
      qt_meta_data_FixedFontSelector, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &FixedFontSelector::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FixedFontSelector))
