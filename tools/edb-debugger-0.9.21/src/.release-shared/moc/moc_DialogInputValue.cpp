...
static const char qt_meta_stringdata_DialogInputValue[] = {
    "DialogInputValue\0\0on_hexInput_textEdited(QString)\0"
    "on_signedInput_textEdited(QString)\0"
    "on_unsignedInput_textEdited(QString)\0"
};
...
const QMetaObjectExtraData DialogInputValue::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject DialogInputValue::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_DialogInputValue,
      qt_meta_data_DialogInputValue, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &DialogInputValue::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DialogInputValue))
