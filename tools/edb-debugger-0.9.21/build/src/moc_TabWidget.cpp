...
QT_MOC_LITERAL(1, 10, 26), // "customContextMenuRequested"
QT_MOC_LITERAL(2, 37, 0) // ""

    },
    "TabWidget\0customContextMenuRequested\0"
    ""
};
...
void TabWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->customContextMenuRequested((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< const QPoint(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (TabWidget::*_t)(int , const QPoint & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TabWidget::customContextMenuRequested)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TabWidget::customContextMenuRequested(int _t1, const QPoint & _t2)
{
