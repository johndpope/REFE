...
const QMetaObject ProcessModel::staticMetaObject = {
    { &QAbstractItemModel::staticMetaObject, qt_meta_stringdata_ProcessModel.data,
      qt_meta_data_ProcessModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
