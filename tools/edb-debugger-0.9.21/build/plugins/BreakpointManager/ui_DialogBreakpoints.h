...
public:
    ...
    void setupUi(QDialog *DialogBreakpoints)
    {
        if (DialogBreakpoints->objectName().isEmpty())
            DialogBreakpoints->setObjectName(QStringLiteral("DialogBreakpoints"));
        ...
        QIcon icon(QIcon::fromTheme(QStringLiteral("document-import")));
        btnImport->setIcon(icon);

        gridLayout->addWidget(btnImport, 4, 1, 1, 1);

        btnCondition = new QPushButton(DialogBreakpoints);
        btnCondition->setObjectName(QStringLiteral("btnCondition"));
        ...
        QIcon icon1(QIcon::fromTheme(QStringLiteral("dialog-close")));
        ...
        QIcon icon2(QIcon::fromTheme(QStringLiteral("list-remove")));
        ...
        QIcon icon3(QIcon::fromTheme(QStringLiteral("list-add")));
        ...
        QIcon icon4(QIcon::fromTheme(QStringLiteral("document-export")));
    ...
    {
        DialogBreakpoints->setWindowTitle(QApplication::translate("BreakpointManager::DialogBreakpoints", "Breakpoint Manager", 0));
        btnImport->setText(QApplication::translate("BreakpointManager::DialogBreakpoints", "&Import Breakpoints", 0));
        btnCondition->setText(QApplication::translate("BreakpointManager::DialogBreakpoints", "Set Breakpoint &Condition", 0));
        okButton->setText(QApplication::translate("BreakpointManager::DialogBreakpoints", "&Close", 0));
        btnRemove->setText(QApplication::translate("BreakpointManager::DialogBreakpoints", "&Remove Breakpoint", 0));
        btnAdd->setText(QApplication::translate("BreakpointManager::DialogBreakpoints", "&Add Breakpoint", 0));
        QTableWidgetItem *___qtablewidgetitem = tableWidget->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("BreakpointManager::DialogBreakpoints", "Address", 0));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidget->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("BreakpointManager::DialogBreakpoints", "Condition", 0));
        QTableWidgetItem *___qtablewidgetitem2 = tableWidget->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("BreakpointManager::DialogBreakpoints", "Original Byte", 0));
        QTableWidgetItem *___qtablewidgetitem3 = tableWidget->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("BreakpointManager::DialogBreakpoints", "Type", 0));
        QTableWidgetItem *___qtablewidgetitem4 = tableWidget->horizontalHeaderItem(4);
        ___qtablewidgetitem4->setText(QApplication::translate("BreakpointManager::DialogBreakpoints", "Function", 0));
        btnExport->setText(QApplication::translate("BreakpointManager::DialogBreakpoints", "&Export Breakpoints", 0));
    } // retranslateUi
