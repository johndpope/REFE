...
#include "../../../plugins/Analyzer/SpecifiedFunctions.h"
...
struct qt_meta_stringdata_Analyzer__SpecifiedFunctions_t {
    QByteArrayData data[5];
    char stringdata0[93];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Analyzer__SpecifiedFunctions_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Analyzer__SpecifiedFunctions_t qt_meta_stringdata_Analyzer__SpecifiedFunctions = {
    {
QT_MOC_LITERAL(0, 0, 28), // "Analyzer::SpecifiedFunctions"
QT_MOC_LITERAL(1, 29, 30), // "on_function_list_doubleClicked"
QT_MOC_LITERAL(2, 60, 0), // ""
QT_MOC_LITERAL(3, 61, 5), // "index"
QT_MOC_LITERAL(4, 67, 25) // "on_refresh_button_clicked"

    },
    "Analyzer::SpecifiedFunctions\0"
    "on_function_list_doubleClicked\0\0index\0"
...
const QMetaObject Analyzer::SpecifiedFunctions::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Analyzer__SpecifiedFunctions.data,
      qt_meta_data_Analyzer__SpecifiedFunctions,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Analyzer::SpecifiedFunctions::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Analyzer__SpecifiedFunctions.stringdata0))
