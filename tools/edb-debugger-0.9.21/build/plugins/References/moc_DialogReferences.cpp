...
#include "../../../plugins/References/DialogReferences.h"
...
struct qt_meta_stringdata_References__DialogReferences_t {
    QByteArrayData data[7];
    char stringdata0[118];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_References__DialogReferences_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_References__DialogReferences_t qt_meta_stringdata_References__DialogReferences = {
    {
QT_MOC_LITERAL(0, 0, 28), // "References::DialogReferences"
QT_MOC_LITERAL(1, 29, 14), // "updateProgress"
QT_MOC_LITERAL(2, 44, 0), // ""
QT_MOC_LITERAL(3, 45, 18), // "on_btnFind_clicked"
QT_MOC_LITERAL(4, 64, 31), // "on_listWidget_itemDoubleClicked"
QT_MOC_LITERAL(5, 96, 16), // "QListWidgetItem*"
QT_MOC_LITERAL(6, 113, 4) // "item"

    },
    "References::DialogReferences\0"
    "updateProgress\0\0on_btnFind_clicked\0"
...
void References::DialogReferences::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (DialogReferences::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DialogReferences::updateProgress)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject References::DialogReferences::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_References__DialogReferences.data,
      qt_meta_data_References__DialogReferences,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *References::DialogReferences::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_References__DialogReferences.stringdata0))
